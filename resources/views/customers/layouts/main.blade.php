...
<link href="{{ asset("https://fonts.googleapis.com/css2?family=Chilanka&family=Montserrat:wght@300;400;500&display=swap") }}"rel="stylesheet">
...
<body>
  ...
  @include('customers.partials.cart')

  @include('customers.partials.header')

  @include('customers.partials.banner')

  <div class="container">
    @yield('content')
  </div>

  @include('customers.partials.banner2')
